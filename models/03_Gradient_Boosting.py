...
This script implements a Gradient Boosting ensemble model with:
...
# ============================================================================
print("\n3. Training baseline Gradient Boosting...")
...
print("Running randomized search (this may take several minutes)...")
...
ax1.set_title('Gradient Boosting: Actual vs Predicted (Training)', fontsize=14)
...
ax2.set_title('Gradient Boosting: Actual vs Predicted (Test)', fontsize=14)
...
ax3.set_title('Gradient Boosting: Residuals Distribution (Test)', fontsize=14)
...
ax4.set_title('Gradient Boosting: Residuals vs Predicted (Test)', fontsize=14)
...
ax5.set_title('Gradient Boosting: Top 20 Feature Importances', fontsize=14)
ax5.grid(True, alpha=0.3, axis='x')
ax5.invert_yaxis()

plt.savefig('results/figures/03_gradient_boosting.png', dpi=300, bbox_inches='tight')
print("✓ Saved: results/figures/03_gradient_boosting.png")
plt.close()
...
results = {
    ...
    'learning_rate': random_search.best_params_['regressor__learning_rate'],
    ...
    'subsample': random_search.best_params_['regressor__subsample'],
...
results_df.to_csv('results/03_gradient_boosting_results.csv', index=False)
print("✓ Saved: results/03_gradient_boosting_results.csv")

# Save feature importance
feature_importance_df.to_csv('results/03_gradient_boosting_feature_importance.csv', index=False)
print("✓ Saved: results/03_gradient_boosting_feature_importance.csv")

# Save model
with open('results/03_gradient_boosting_model.pkl', 'wb') as f:
    pickle.dump(best_model, f)
print("✓ Saved: results/03_gradient_boosting_model.pkl")
...
print(f"  learning_rate: {random_search.best_params_['regressor__learning_rate']}")
...
print(f"  subsample: {random_search.best_params_['regressor__subsample']}")
...
print(f"\nKey Insights:")
print(f"  • Sequential boosting builds strong predictive model")
print(f"  • Learning rate controls overfitting")
print(f"  • Often achieves best performance among classical methods")
print(f"  • R² of {test_r2_best:.4f} shows excellent predictive power")
print("\n" + "="*80)
